...
import cupy as np
from cupy.testing import assert_array_less, assert_allclose
from pytest import raises as assert_raises

from scipy_cupy.linalg import inv, eigh, norm
from scipy_cupy.linalg import orthogonal_procrustes
