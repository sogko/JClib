...
import math
import cupy as np
from cupy import sqrt, cos, sin, arctan, exp, log, pi, Inf
from cupy.testing import (assert_,
        assert_allclose, assert_array_less, assert_almost_equal)
import pytest

from scipy_cupy.integrate import quad, dblquad, tplquad, nquad
from scipy_cupy.special import erf, erfc
from scipy_cupy._lib._ccallback import LowLevelCallable

import ctypes
import ctypes.util
from scipy_cupy._lib._ccallback_c import sine_ctypes

import scipy_cupy.integrate._test_multivariate as clib_test
